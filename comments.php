...
if ($slideshow->commentsallowed) {
    ...
    if (has_capability('moodle/course:update', $coursecontext)) {
        ...
        $mform = new mod_slideshow_comment_form('comments.php', array('htmledit' => $htmledit, 'context' => $context,
            'slideshowid' => $slideshow->id, 'slidenumber' => $img_num, 'imgfilename' => $img_filename));
        $mform->display();
    } else {
