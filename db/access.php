...
$capabilities = array(
    ...
    // Ability to add a new slideshow to the course.
    ...
    // Edit the slideshow settings, add and remove images.
    'mod/slideshow:manage' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
    ...
    // Preview the slideshow (do we need this?)
    'mod/slideshow:preview' => array(
