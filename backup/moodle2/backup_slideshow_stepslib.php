...
class backup_slideshow_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $slideshow = new backup_nested_element('slideshow', array('id'), array(
            'name', 'location', 'layout', 'filename', 'delaytime', 'centred',
            'autobgcolor', 'timemodified', 'htmlcaptions', 'commentsallowed', 'keeporiginals'));
        ...
        $media_entry = new backup_nested_element('media_entry', array('id'), array('slideshowid', 'slidenumber',
