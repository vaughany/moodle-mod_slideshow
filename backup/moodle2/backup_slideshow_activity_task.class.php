...
require_once($CFG->dirroot . '/mod/slideshow/backup/moodle2/backup_slideshow_stepslib.php'); // Because it exists (must).

/**
 * slideshow backup task that provides all the settings and steps to perform one
