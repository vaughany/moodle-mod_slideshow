...
require_once($CFG->dirroot . '/mod/slideshow/backup/moodle2/restore_slideshow_stepslib.php'); // Because it exists (must).

/**
 * slideshow restore task that provides all the settings and steps to perform one
...
class restore_slideshow_activity_task extends restore_activity_task {
    ...
    static public function define_decode_contents() {
        ...
        // $contents[] = new restore_decode_content('slideshow', array('contents'), 'slideshow');
     ...
     * slideshow logs. It must return one array
